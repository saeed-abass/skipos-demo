...
const labelClass = 'mb-1 block text-sm font-medium text-soft-text'
  ...
  return (
    <div className="w-full max-w-md">
      <div className="rounded-card bg-white p-8 shadow-soft-md">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-soft-text">Welcome back</h1>
          <p className="mt-1 text-sm text-soft-muted">Sign in to your SkipOS account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
          ...
          <div>
            ...
            <div className="mt-1.5 text-right">
              <Link href="/reset-password" className="text-sm text-orange-500 hover:text-orange-600 transition-colors">
        ...
        <div className="my-5 flex items-center gap-3">
          ...
          <span className="text-xs text-soft-muted">or</span>
          <div className="h-px flex-1 bg-gray-200" />
        </div>
